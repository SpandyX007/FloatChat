...
def process_query(query: str) -> Dict[str, Any]:
    ...
    system_instruction = (
        ...
        "into explicit start and end dates. Use today's date context when relative ranges are given. "
        "Return ONLY a JSON object that matches the schema.\n"
        "- parameters (array of strings) mapped to the dataframe columns that are:['profile_date', 'TEMP_Surface(0-100m)', 'PSAL_Surface(0-100m)', 'RHO_Surface(0-100m)', 'N2_Surface(0-100m)', 'SOUND_Surface(0-100m)', 'TEMP_Thermocline(100-500m)', 'PSAL_Thermocline(100-500m)', 'RHO_Thermocline(100-500m)', 'N2_Thermocline(100-500m)', 'SOUND_Thermocline(100-500m)', 'TEMP_UpperMesopelagic(500-1000m)', 'PSAL_UpperMesopelagic(500-1000m)', 'RHO_UpperMesopelagic(500-1000m)', 'N2_UpperMesopelagic(500-1000m)', 'SOUND_UpperMesopelagic(500-1000m)', 'TEMP_LowerMesopelagic(1000-2000m)', 'PSAL_LowerMesopelagic(1000-2000m)', 'RHO_LowerMesopelagic(1000-2000m)', 'N2_LowerMesopelagic(1000-2000m)', 'SOUND_LowerMesopelagic(1000-2000m)']\n"
        "- depth (string)\n"
...
def process_response(response: Any) -> Dict[str, Any]:
    ...
    """
    system_instruction=(
        "You are an expert data analyst. Given a DataFrame, "
